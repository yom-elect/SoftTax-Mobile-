// local imgs
const Onboarding = require("../assets/imgs/softTax-bg.png");
const Logo = require("../assets/imgs/softTax-logo.png");
const LogoOnboarding = require("../assets/imgs/softTax-logo-login.png");
const ProfileBackground = require("../assets/imgs/softTax-bg.png");
const RegisterBackground = require("../assets/imgs/softTax-bg.png");
const Pro = require("../assets/imgs/getPro-bg.png");
const ArgonLogo = require("../assets/imgs/softTax-logo-login.png");
